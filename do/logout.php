...
do_logout();
//do_sendnotification($_SESSION['user_id'], "feedback", array("message" => "You have been logged out. See you next time!", $modlog=false));
// todo, we don't have support for logged out notifs yet, but we could do cookie based ones for that. would be a nice quality of life improvement.
